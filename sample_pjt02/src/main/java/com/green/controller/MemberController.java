...
//		
////		model 로 담기
//		model.addAttribute("user_id", id);  // 여기서 쓴 "user_id" 을 signInResult.html 에 적어야함!
...
//	ModelAndView 클래스는 Model 과 View 를 하나로 합져서 클라이언트에 전달한다.
	@PostMapping("/member/signin_confirm")
...
//		modelNview 에 담기
		modelNview.addObject("id", id);
		modelNview.addObject("pw", pw);
